    ...
    <div class="common-layout">
        <el-container>
            <el-card class="box-card">
                <el-header class="model-selection" style="padding: 0">
                    ...
                    <div style="float: right">
                        <el-text class="mx-1" type="success"
                            style="text-align: right;">用户对话记录最多保存1200字的长度，超过长度将会重置</el-text>
                    </div>
                ...
                <el-aside style="width: 11%;float: left;
                display: flex;flex-direction: column;">
                    <el-button style="margin-top: 4vh;width: 100%;" @click="clear">清空对话记录</el-button>
                    <el-button style="margin-top: 4vh;width: 100%;margin-left: 0%;" @click="clears">使用自己的API</el-button>
                </el-aside>
                <!-- 消息容器 -->
                        ...
                        <el-card>
                            <template #header>
                                <div v-if="message.isUser" class="card-header">
                                    ...
                                    <div>
                                        <el-avatar
                                            src="https://www.rhzhz.cn/wp-content/uploads/2023/11/20220714222919_c0aa1.thumb_.1000_0.jpg" />
                                    </div>
                                </div>
                                <div v-else class="card-header">
                                    <div>
                                        <el-avatar
                                            src="https://www.rhzhz.cn/wp-content/uploads/2022/08/Gravity_Falls_BillCipherCursor.png" />
                                    </div>
                            ...
                            <div v-else-if="message.content" class="text-message"
                                v-html="parseMarkdown(message.content)"></div>
                ...
                <div class="chat-input">
                    ...
                    <el-button :disabled="robotIsReplying" @click="sendMessage" type="primary"
                        style="margin-left: 1%;">发送</el-button>
                </div>
            </el-card>
        </el-container>
    </div>
